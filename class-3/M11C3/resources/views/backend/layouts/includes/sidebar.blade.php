          ...
          <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
              ...
              <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="imageupload">
                  <ul class="nav nav-sm flex-column">
              ...
              <li class="nav-item">
                <a
                  ...
                  role="button"
                  aria-expanded="false"
                  aria-controls="galleryapp"
                >
                  <i data-feather="grid" class="icon-dual"></i>
                  <span data-key="t-apps">Gallery App</span>
                </a>
                <div class="collapse menu-dropdown" id="galleryapp">
                  <ul class="nav nav-sm flex-column">
